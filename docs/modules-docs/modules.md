...
Here is a list of all production-grade modules that can be used on the DE EVM blockchain, along with their respective documentation:
...
- [erc20](erc20.md) - Trustless, on-chain bidirectional internal conversion of tokens between Evmos' EVM and Cosmos runtimes.
...
- [inflation](inflation.md) - Mint tokens and allocate them to staking rewards, usage incentives and community pool.
...
## Cosmos SDK[](https://docs.evmos.org/protocol/modules#cosmos-sdk)

DE EVM uses the following Cosmos SDK modules:
...
## IBC[](https://docs.evmos.org/protocol/modules#ibc)
